...
class Neural_kernel(nn.Module):
    ...
    Args:
        RBF: length_scale (float): The length scale value.
        Linear: variance (float) : A variance parameter.
        RQ: lengthscale and alpha(float): The lengthscale parameter. The rational quadratic relative weighting parameter.
        feature: the feature dim of input vector.
        base_kernel_num: the number of base kernel.
    Attributes:
